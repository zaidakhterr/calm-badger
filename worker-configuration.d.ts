/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: bed678107370365244f56fdc4ffd7f0f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OCR_PROVIDER" | "MISTRAL_OCR_MODEL" | "EXTRACTION_PROVIDER" | "RERANK_PROVIDER" | "REVIEW_WINDOW_SECONDS_CURATED" | "REVIEW_WINDOW_SECONDS_CUSTOM" | "ANALYTICS_PROVIDER" | "POSTHOG_HOST" | "APP_ENV" | "LANGFUSE_PROVIDER" | "MISTRAL_API_KEY" | "OPENROUTER_API_KEY" | "POSTHOG_API_KEY" | "RATE_LIMIT_SALT" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_SECRET_KEY" | "LANGFUSE_BASE_URL">> {}
}
